...
def comp_class_vec(ouput_vec, index=None):
    ...
    one_hot = torch.zeros(ouput_vec.size()).scatter_(1, index, 1)
...
if __name__ == '__main__':
    ...
    # path_img = os.path.join(BASE_DIR,  '.',"Data", "pretrain_visual_data", "tiger cat.jpg")
    # path_net = os.path.join(BASE_DIR, "..", "..", "Data", "net_params_72p.pkl")
    # output_dir = os.path.join(BASE_DIR, "..", "..", "Result", "backward_hook_cam")
    path_img = os.path.join('../Data/pretrain_visual_data', "tiger cat.jpg")
    output_dir = os.path.join("backward_hook_cam")
    ...
    for name, module in net.features.named_children():
        print(name)
        if name == '10':
            module.register_forward_hook(farward_hook)
